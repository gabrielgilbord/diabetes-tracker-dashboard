-- Crear tabla para datos del Polar H10 recogidos automáticamente
CREATE TABLE IF NOT EXISTS polar_data (
    ...
    CONSTRAINT fk_polar_data_username FOREIGN KEY (username) REFERENCES users("Username") ON DELETE CASCADE
);
