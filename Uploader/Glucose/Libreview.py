# libreview_processor.py

import pandas as pd
import os


class LibreviewProcessor:
    """
    Procesador específico para archivos CSV de glucosa del modelo Libreview.
    ...
    def __init__(self):
        ...
        self.date_col = "Sello de tiempo del dispositivo"
        self.glucose_col = "Historial de glucosa mg/dL"
        self.header_row = 2
...
if __name__ == "__main__":
    ...
    processor = LibreviewProcessor()

    # Obtener la ruta del directorio donde está este archivo Python
    script_dir = os.path.dirname(os.path.abspath(__file__))

    # Construir la ruta al archivo libreview.csv relativa al archivo Python
    ruta = os.path.join(script_dir, "libreview.csv")
